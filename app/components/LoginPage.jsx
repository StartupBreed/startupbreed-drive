    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-50 to-blue-100">
      <div className="bg-white rounded-2xl shadow-xl p-10 w-full max-w-md text-center">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-5 py-3 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors font-medium text-gray-700"
        >
          <GoogleIcon />
          Sign in with Google
        </button>
        ...
        <p className="text-xs text-gray-400 mt-6">
          We only request access to your Google Drive files.
        </p>
      </div>
    </div>
  );
